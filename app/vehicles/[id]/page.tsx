...
export default function VehicleProfilePage({ params }: { params: { id: string } }) {
  ...
  const documents = [
    ...
    },
    {
      ...
      issuer: 'Ford Service Centre',
      certificateNumber: 'SVC-2026-001',
    ...
    },
    {
      ...
      title: 'Road Tax',
      issuer: 'DVLA',
      certificateNumber: 'TAX-AB12CDE-2025',
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mt-1">{vehicle.make} {vehicle.model} ({vehicle.year})</p>
            ...
            <div className="card">
              ...
              <dl className="space-y-3">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{vehicle.mileage} miles</dd>
                </div>
              </dl>
            </div>
            ...
            <div className="card">
              ...
              <dl className="space-y-3">
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">{vehicle.owner}</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-gray-500">Current Depot</dt>
                  <dd className="mt-1 text-sm text-gray-900">{vehicle.depot}</dd>
                </div>
                <div>
              ...
              <div key={index} className="flex items-start space-x-3 text-sm p-3 rounded-lg bg-gray-50">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900 font-medium">{service.cost}</span>
                  </div>
                  <p className="text-gray-500 text-xs mt-1">
                    {service.date} · {service.mileage} miles · {service.location}
                  </p>
                </div>
              </div>
            ))}
          </div>
          <button className="btn-secondary w-full mt-4">View Full Service History</button>
        </div>
      </div>
    </AppLayout>
  )
